...
! Arguments:
      ...
      CHARACTER :: CALPHA*(*),CBINFLAG*(*),CFLPAR*(*),CFLSHP*(*),CMDSOL*(*), &
...
!                           implemented by Sarkar, Yang, & Arvas 1988
      ...
      IF(CMDSOL=='bicgs2')CMDSOL='BICGS2'
      IF(CMDSOL=='bicgs4')CMDSOL='BICGS4'
      IF(CMDSOL=='gpbgs2')CMDSOL='GPBGS2'
      IF(CMDSOL=='gpbgs4')CMDSOL='GPBGS4'
